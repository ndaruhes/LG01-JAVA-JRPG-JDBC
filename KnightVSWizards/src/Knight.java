...
public class Knight extends Character{
	...
	public void Defend(int damage) {
		...
		if(damage < (this.getDefense() + this.getShieldDefense())) {
			...
			System.out.println(" Knight has taken - " + (damage - (this.getDefense() + this.getShieldDefense())) + " Damage");
			System.out.println(" Knight has deflected a total of - " + (this.getDefense() + this.getShieldDefense()) + " Damage");
